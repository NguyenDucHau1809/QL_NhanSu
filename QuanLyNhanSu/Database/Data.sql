...
AS 
BEGIN
	SELECT NV.MANV, NV.HOTEN, HOTENTN, TN.GIOITINH, TN.NGSINH, TN.QUANHE
...
AS
BEGIN
	SELECT NV.MANV, NV.HOTEN, HOTENTN, TN.GIOITINH, TN.NGSINH, QUANHE
	FROM THANNHAN AS TN, NHANVIEN AS NV
	WHERE NV.MANV = TN.MANV 
	AND ((TN.MANV LIKE N'%' + @SEARCHVALUE + '%') OR (TN.HOTENTN  LIKE N'%' + @SEARCHVALUE + '%') OR (TN.GIOITINH LIKE N'%' + @SEARCHVALUE + '%') OR (TN.QUANHE LIKE N'%' + @SEARCHVALUE + '%')) 
END
GO

--Insert data use procedure
[dbo].[SP_ThanNhan_INSERT] 3, N'Võ Thị Thanh Thảo', N'Nữ', '19790118', N'Mẹ'
go

[dbo].[SP_ThanNhan_INSERT] 3, N'Nguyễn Xuân Bình', N'Nam', '19760112', N'Cha'
go

[dbo].[SP_ThanNhan_INSERT] 3, N'Lê Thị Thu Thảo', N'Nữ', '19760101', N'Con'
go
